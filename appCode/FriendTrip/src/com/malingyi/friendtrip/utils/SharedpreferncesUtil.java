package com.malingyi.friendtrip.utils;
...
public static final String PREFERNCE_FILE_NAME = "obj"; // 缓存文件名
	...
	public static final String KEY_PCENTER_INFO = "pcenterinfo";
	//----collection----
	...
	public static PersonalCenter getPcenterInfo(Context mContext) {
		// TODO Auto-generated method stub
		return (PersonalCenter)readObj(mContext, KEY_PCENTER_INFO);
	}

	public static void savePcenterInfo(Context mContext,
			PersonalCenter pCenterinfo) {
		// TODO Auto-generated method stub
		saveObj(mContext, pCenterinfo, KEY_PCENTER_INFO);
	}
